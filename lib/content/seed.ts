...
export const seedContent: SiteContent = {
  ...
  about: {
    ...
    mission: L(
      'לייצר נגרות מותאמת אישית ברמת גימור גבוהה, מההקשבה ועד ההתקנה.',
      'تصنيع نجارة مخصصة بمستوى تشطيب عالٍ، من الإنصات حتى التركيب.',
      'To create custom millwork at a high finish standard, from listening through to installation.',
      'Создавать индивидуальную столярку высокого уровня — от понимания задачи до монтажа.',
    ),

    vision: L(
      'מרחבים מדויקים, חמים ועמידים שמשרתים את הבית ואת העסק לאורך שנים.',
      'مساحات دقيقة ودافئة ومتينة تخدم المنزل والعمل لسنوات.',
      'Precise, warm, lasting spaces that serve home and business for years.',
      'Точные, тёплые и долговечные пространства для дома и бизнеса.',
    ),
  ...
  faqPage: {
    eyebrow: L('שאלות', 'أسئلة', 'FAQ', 'Вопросы'),
    title: L('שאלות נפוצות', 'الأسئلة الشائعة', 'Frequently Asked Questions', 'Частые вопросы'),
    subtitle: L(
      'תשובות קצרות לפני השיחה',
      'إجابات موجزة قبل المكالمة',
      'Short answers before you call',
      'Краткие ответы перед звонком',
    ),
  },

  blogPage: {
    eyebrow: L('בלוג', 'المدونة', 'Blog', 'Блог'),
    title: L('מאמרים ועדכונים', 'مقالات وتحديثات', 'Articles & Updates', 'Статьи и новости'),
    subtitle: L(
      'חומרים, תהליך ותכנון נכון',
      'خامات وعملية وتخطيط سليم',
      'Materials, process, and sound planning',
      'Материалы, процесс и грамотное планирование',
    ),
  },
